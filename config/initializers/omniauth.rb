Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  if Rails.env.production?
    ...
    provider :facebook, '1473730946221977', 'ef7ffc5bb5061cc121b20a8bb9f589de', { :secure_image_url => 'true' }
  else
    provider :google_oauth2, '306861178343-99tuadim60lb4akbtrsv2vgr61hr44hh.apps.googleusercontent.com', 'e1G-MdVWevlcPmBPiiJfKTmP'
    provider :facebook, '1488856108046077', '3d73c12cdb2605e8be35e079118198b9', { :secure_image_url => 'true' }
  end
end
